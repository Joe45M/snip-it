...
<body>
    <div class="pop-wrap">
        <div class="pop-content">
            <h1 class="page-title">Snipped!</h1>
        </div>
    </div>
    <div class="heading">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-title">Snip-it</h1>
                    <p>Welcome to Snip-it (get it?). HTML is tiresome and repetitive. One of the most boring yet important parts of a Web Developers job... why do we do this to ourselves? Because... well... I don't know, dude. I really don't. Anyway, I made some snippits (GET IT?), take them and do as you please. Probably some cool features coming soon, who knows.</p>
                    <div class="search-bar">
                        <input placeholder="Search for a snippit..." type="text">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-columns">
                        <div class="card">  
                            <div class="card-body">
                                <h5 class="card-title">DAY SELECT</h5>
...
<pre>
    ...
    &lt;/select&gt;
                        ...
                        <div class="card">  
                            <div class="card-body">
                                <h5 class="card-title">MONTH SELECT</h5>
...
<pre>
    ...
    &lt;/select&gt; 
                        ...
                        <div class="card">  
                            <div class="card-body">
                                <h5 class="card-title">D.O.B Select</h5>
                                <button class="btn btn-sm btn-primary ctc">
                                    Copy
                                </button>
<pre><code class="language-html">    &lt;select name="year"&gt; 
    ...
    <textarea id="clip-copy-off-screen"></textarea>
